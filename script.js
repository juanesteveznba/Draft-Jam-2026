...
const SCOUT_DATA = {
  ...
  "MARK MITCHELL": `
    <h3>SCOUTING REPORT</h3>
    <p>. BUENA ALTURA PARA 4; BRAZOS LARGOS</p>
    <p>. PROMEDIO DESDE LO ATLETICO; FUERTE</p>
    <p>. VIENE DE SU MEJOR AÑO DE TRES: 39%</p>
    <p>. TRES AÑOS PREVIOS: 30% EN 3P</p>
    <p>. MALA MECANICA DE TIRO; 65% EN FT</p>
    <p>. ATACA DE FRENTE; MAL DEFINIDOR</p>
    <p>. INTERESANTE PROGRESO PASADOR</p>
    <p>. DEFENSOR INTENSO Y FISICO</p>
    <p>. MAL REBOTERO PARA SU TAMAÑO</p>
    <p>. POCOS ROBOS O TAPONES</p>
    <p>. VALOR: UNDRAFTED</p>
  `,

  "DJ ARMSTRONG": `
    <h3>SCOUTING REPORT</h3>
    <p>. BAJO PARA 1-2; BRAZOS LARGOS</p>
    <p>. NO DESTACA DESDE LO ATLETICO</p>
    <p>. ESPECIALISTA TRIPLERO</p>
    <p>. 42% EN MAS DE 6 INTENTOS</p>
    <p>. BUENA MECANICA Y ALCANCE</p>
    <p>. CAPAZ DE LANZAR DESDE EL DRIBLE</p>
    <p>. ARRIBA DEL 90% EN TIROS LIBRES</p>
    <p>. NO PISA LA PINTURA; NO CREA/ASISTE</p>
    <p>. SIN POTENCIAL DEFENSIVO</p>
    <p>. POCO REBOTE Y ROBOS</p>
    <p>. VALOR: UNDRAFTED</p>
  `,

  "MALIQUE LEWIS": `
    <h3>SCOUTING REPORT</h3>
    <p>. BUENA ALTURA; BRAZOS LARGOS</p>
    <p>. POTENTE; NO MUY EXPLOSIVO</p>
    <p>. 37% EN 3P EN LA 2025-2026</p>
    <p>. 33% EN 3P EN TRES AÑOS PREVIOS</p>
    <p>. NO ANOTA NI CREA DESDE EL DRIBLE</p>
    <p>. CASI NO SACA INFRACCIONES</p>
    <p>. FLASHES INTERESANTES DE PASADOR</p>
    <p>. 3 ASIS x CADA PERDIDA EN 2025-26</p>
    <p>. BUEN DEFENSOR; FISICO Y ENERGIA</p>
  ...
  "MOHAMMAD AMINI": `
    <h3>SCOUTING REPORT</h3>
    <p>. BUENA ALTURA PARA 3</p>
    <p>. BUEN ATLETA FIBA, NO ASI NBA</p>
    <p>. TIRADOR IRREGULAR DE TRES</p>
    <p>. 26% 3P EN 25-26; 35% EN LA 24-25</p>
    <p>. APENAS UN 60% EN TIROS LIBRES</p>
    <p>. MAS PELIGROSO ATACANDO EL ARO</p>
    <p>. USA BIEN EL CUERPO PARA ATACAR</p>
    <p>. NO SOBRESALE COMO PASADOR</p>
    <p>. BUEN REBOTERO PARA SER ALERO</p>
    <p>. SOLIDO POTENCIAL DEFENSIVO FIBA</p>
    <p>. VALOR: UNDRAFTED</p>
  `,

  "VSEVOLOD ISHCHENKO": `
    <h3>SCOUTING REPORT</h3>
    <p>. BUENA ALTURA PARA 3/4</p>
    <p>. SOLIDO DESDE LO ATLETICO</p>
    <p>. EXCELENTES % EN TRIPLES: 45%</p>
    <p>. APENAS 1.5 3PA POR PARTIDO</p>
    <p>. MANEJA Y PUEDE SUBIR LA BOLA</p>
    <p>. SIN DRIBLE SEGURO PARA CREAR</p>
    <p>. CORTES Y PUNTOS EN TRANSICION</p>
    <p>. DESTELLOS COMO PASADOR</p>
    <p>. DEFENSOR VERSATIL; BUEN POTENCIAL</p>
    <p>. BUENOS NUMEROS EN REB, STL Y BLK</p>
    <p>. VALOR: 2° RONDA</p>
  `,
  ...
  "NOAM YAACOV": `
    <h3>SCOUTING REPORT</h3>
    <p>. BAJO, LIVIANO; BRAZOS CORTOS</p>
  ...
  "JACK KAYIL": `
    <h3>SCOUTING REPORT</h3>
    <p>. BUEN FISICO PARA 1-2</p>
    <p>. NO SOBRESALE DESDE LO ATLETICO</p>
    <p>. TIRADOR DE MUCHA CONFIANZA</p>
    <p>. APENAS UN 30% EN 3P EN LA 25-26</p>
    <p>. TOMA TIROS DIFICILES; ALCANCE NBA</p>
    <p>. GENERA JUEGO DESDE PICK AND ROLL</p>
    <p>. AGRESIVO; SACA MUCHAS FALTAS</p>
    <p>. LINDOS PASES; MUCHAS PERDIDAS</p>
    <p>. DEFENSOR INTENSO Y FISICO</p>
    <p>. AYUDA EN EL REBOTE Y CON ROBOS </p>
    <p>. VALOR: 2° RONDA</p>
  `,

  "SERGIO De LARREA": `
    <h3>SCOUTING REPORT</h3>
    <p>. GRAN ALTURA PARA LA POSICION</p>
    <p>. RITMO, VELOZ; NO TAN EXPLOSIVO</p>
    <p>. BUEN TIRADOR: 39% 3P EN LA 25-26</p>
    <p>. CAPAZ DE LANZAR DESDE EL DRIBLE</p>
    <p>. GENERA JUEGO DESDE PICK AND ROLL</p>
    <p>. NO MUY SEGURO COMO DEFINIDOR</p>
    <p>. BUEN PASADOR; DESPRENDIDO</p>
    <p>. DEBE BAJAR PERDIDAS Y FALTAS</p>
    <p>. DEFENSOR INTENSO; ENERGIA</p>
